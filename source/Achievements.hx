...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Rearranger",					"Beat the Rubix Week on Hard.",						'rearranger',			false],
		["The End of This!",			"Beat the Rubix-v-Tord Week on Hard.",	 			'the_end',				false],
		["Rude Person",					"Beat the Peep Week on Hard.",	 					'rude',					false],	
		["Not so Cute Cat!",			"Beat the Cal week on HARD.",						'cal',					false],
		...
		["Rearranger",					"Beat the Rubix Week on Hard.",	 					'rearranger',			false],		
		["The End of This!",			"Beat the Rubix-v-Tord Week on Hard.",	 			'the_end',				false],
		["Rude Person",					"Beat the Peep-and-Magnet Week on Hard.",	 		'rude',					false]			
	];
